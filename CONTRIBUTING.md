...
Please start a discussion on the [core repo issue tracker](https://github.com/ppossanzini/MapZilla/issues).

## Platform
MapZilla is built using the RTM tooling that ships with the latest Visual Studio. This is the only configuration accepted.
...
* [Core](https://github.com/ppossanzini/MapZilla)

## Other discussions
https://gitter.im/ppossanzini/MapZilla
...
1. Did you read the [documentation](https://MapZilla.readthedocs.io/en/latest/)?
