...
public ref struct TypeMapPlanBuilder(IGlobalConfiguration configuration, TypeMap typeMap)
{
    ...
    private static MapZillaMappingException MemberMappingError(Exception innerException, MemberMap memberMap) => new("Error mapping types.", innerException, memberMap);
    ...
    private Expression CreateNewDestinationFunc() => _typeMap switch
    {
        ...
        { DestinationType: { IsInterface: true } interfaceType } => Throw(Constant(new MapZillaMappingException("Cannot create interface "+interfaceType, null, _typeMap)), interfaceType),
...
public class ValueConverter : ValueResolverConfig, IValueResolver
{
    ...
    public Expression GetExpression(IGlobalConfiguration configuration, MemberMap memberMap, Expression source, Expression _, Expression destinationMember)
    {
        ...
        MapZillaConfigurationException BuildExceptionMessage()
