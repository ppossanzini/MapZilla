...
public interface IGlobalConfigurationExpression : IMapperConfigurationExpression, IProfileExpressionInternal
{
    ...
    /// <summary>
    /// How many levels deep should MapZilla try to inline the execution plan for child classes.
    /// See <a href="https://MapZilla.readthedocs.io/en/latest/Understanding-your-mapping.html">the docs</a> for details.
    /// </summary>
...
public interface IProfileExpressionInternal : IProfileExpression
{
    ...
    /// <summary>
    /// Disable method mapping. Use this if you don't intend to have MapZilla try to map from methods.
    /// </summary>
    bool? MethodMappingEnabled { get; set; }
    /// <summary>
    /// Disable fields mapping. Use this if you don't intend to have MapZilla try to map from/to fields.
    /// </summary>
