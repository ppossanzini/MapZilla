...
namespace MapZilla.Extensions.Microsoft.DependencyInjection.Tests.Integrations
{
	public class ServiceLifetimeTests
	{
		...
		public void CanUseDefaultInjectedIMapperInSingletonService()
		{
			...
			services.AddMapZilla(cfg => cfg.CreateMap<Foo, Bar>().ReverseMap(), GetType().Assembly);
