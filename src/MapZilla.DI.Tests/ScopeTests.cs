...
namespace MapZilla.Extensions.Microsoft.DependencyInjection.Tests
{
    public class ScopeTests
    {
        ...
        public void Can_depend_on_scoped_services_as_transient_default()
        {
            ...
            services.AddMapZilla(new [] { typeof(Source).Assembly });
        ...
        {
            var services = new ServiceCollection();
            services.AddMapZilla(new [] { typeof(Source).Assembly }, ServiceLifetime.Scoped);
            services.AddScoped<ISomeService, MutableService>();
        ...
        {
            var services = new ServiceCollection();
            services.AddMapZilla(new [] { typeof(Source).Assembly }, ServiceLifetime.Singleton);
            services.AddScoped<ISomeService, MutableService>();
